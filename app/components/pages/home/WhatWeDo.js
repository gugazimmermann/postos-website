...
const WhatWeDo = () => {
  return (
    <section className='container my-8 space-y-4 md:space-y-8 text-slate-800'>
      <div class='w-full'>
        <h2 class='text-3xl font-bold sm:text-4xl'>O que oferecemos</h2>
      ...
      <div class='mt-8 grid grid-cols-1 gap-8 md:mt-16 md:grid-cols-2 md:gap-12 lg:grid-cols-3'>
        ...
        <div class='flex items-start gap-4'>
          ...
          />
          <div>
            <h2 class='text-lg font-bold'>Transparência</h2>
            <p class='mt-1 text-sm text-slate-500'>
        ...
        <div class='flex items-start gap-4'>
          ...
          />
          <div>
            <h2 class='text-lg font-bold'>Agilidade</h2>
            <p class='mt-1 text-sm text-slate-500'>
        ...
        <div class='flex items-start gap-4'>
          ...
          />
          <div>
            <h2 class='text-lg font-bold'>Veículos</h2>
            <p class='mt-1 text-sm text-slate-500'>
        ...
        <div class='flex items-start gap-4'>
          ...
          />
          <div>
            <h2 class='text-lg font-bold'>Motoristas</h2>
            <p class='mt-1 text-sm text-slate-500'>
