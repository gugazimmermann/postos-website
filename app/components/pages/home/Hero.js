const Hero = () => {
  return (
    <section className='container mx-auto mt-[122px]'>
      ...
      <div className='-mt-[135px] mx-6 md:mx-64 py-10 block rounded-3xl shadow-xl bg-amber-500 backdrop-blur-3xl'>
        <div className='text-slate-800 text-3xl md:text-4xl font-bold text-center leading-snug'>
