  ...
  return (
    <>
      ...
      <SectionParagraph>
        ...
        Frota em Postos de Combustível. Nossa política de privacidade descreve como coletamos,
        usamos e protegemos suas informações pessoais ao utilizar nosso sistema SaaS. Ao acessar ou
        utilizar o {process.env.NEXT_PUBLIC_TITLE}, você concorda com a coleta e uso de suas
        informações de acordo com esta política de privacidade. Se você não concorda com esta
        política, por favor, não utilize nossos serviços.
      </SectionParagraph>
      ...
      <SectionParagraph>
        1.2 Informações de Uso: Coletamos informações sobre o uso do sistema SaaS, incluindo logs de
        atividades, registros de acesso, endereço IP e dados de navegação. Essas informações nos
        ajudam a melhorar o desempenho da plataforma e aprimorar a experiência do usuário.
      </SectionParagraph>
      <SectionParagraph>
      ...
      <SectionParagraph>
        ...
        serviços contratados no {process.env.NEXT_PUBLIC_TITLE}, incluindo o gerenciamento das
        transações da frota e a melhoria contínua da plataforma.
      </SectionParagraph>
      <SectionParagraph>
      ...
      <SectionParagraph>
        ...
        pesquisas de mercado e aprimoramento das funcionalidades do {process.env.NEXT_PUBLIC_TITLE}.
      </SectionParagraph>

      <SectionSubTitle>3. Compartilhamento de Informações</SectionSubTitle>
      <SectionParagraph>
        3.1 Com Terceiros: Não compartilhamos suas informações pessoais com terceiros, exceto quando
      ...
      <SectionParagraph>
        ...
        ajudar na operação do sistema SaaS. Esses provedores têm acesso limitado às suas informações
        pessoais e estão obrigados a proteger sua privacidade.
      </SectionParagraph>
      <SectionParagraph>
      ...
      <SectionParagraph>
        4.2 Acesso Restrito: O acesso às informações pessoais é restrito a funcionários autorizados
        e pessoas que precisam conhecer essas informações para fornecer os serviços contratados.
      </SectionParagraph>
      <SectionParagraph>
      ...
      <SectionParagraph>
        ...
        mantidas pelo {process.env.NEXT_PUBLIC_TITLE}. Caso necessite atualizar seus dados, entre em
        contato conosco através das informações fornecidas abaixo.
      </SectionParagraph>
      <SectionParagraph>
        5.2 Cancelamento da Assinatura: Você pode cancelar sua assinatura e solicitar a exclusão de
        suas informações pessoais do sistema SaaS. Contudo, tenha em mente que a exclusão de algumas
        informações pode afetar a prestação dos serviços.
      </SectionParagraph>
