    ...
    <>
      ...
      <ul className='text-slate-500'>
        ...
        <li className='mt-1'>
          ...
          o sistema {process.env.NEXT_PUBLIC_TITLE}.
        </li>
        <li className='mt-1'>
      ...
      <SectionParagraph>
        2.3 Uso Legal: Os usuários concordam em utilizar o {process.env.NEXT_PUBLIC_TITLE} em
      ...
      <SectionParagraph>
        2.4 Serviços de Terceiros: O {process.env.NEXT_PUBLIC_TITLE} pode integrar-se a serviços ou
      ...
      <SectionParagraph>
        ...
        sobre os dados fornecidos ao {process.env.NEXT_PUBLIC_TITLE}. Nós não reivindicamos a
      ...
      <SectionParagraph>
        3.4 Conformidade: O {process.env.NEXT_PUBLIC_TITLE} cumpre as leis aplicáveis de proteção de
      ...
      <SectionParagraph>
        4.4 Alterações nos Preços: O {process.env.NEXT_PUBLIC_TITLE} reserva-se o direito de alterar
      ...
      <SectionParagraph>
        5.3 Licença de Dados do Cliente: Os clientes concedem ao {process.env.NEXT_PUBLIC_TITLE} o
      ...
      <SectionParagraph>
        6.1 Sem Garantia: O {process.env.NEXT_PUBLIC_TITLE} fornece o sistema SaaS &quot;como
      ...
      <SectionParagraph>
        6.2 Danos Indiretos: O {process.env.NEXT_PUBLIC_TITLE} não será responsável por quaisquer
      ...
      <SectionParagraph>
        7.2 Rescisão pelo {process.env.NEXT_PUBLIC_TITLE}: O {process.env.NEXT_PUBLIC_TITLE} pode
      ...
      <SectionParagraph>
        8.1 Alterações nos Termos de Uso: O {process.env.NEXT_PUBLIC_TITLE} reserva-se o direito de
