          ...
          <div className='flex h-full items-center rounded-lg bg-amber-600 p-2 md:p-6 text-white text-left'>
            <div className='md:pl-12'>
              ...
              <p>
                ...
                Combustíveis, o <AppTitle inverted={true} /> está pronto para
              ...
              <p>
                Cadastrando um Posto, você pode controlar os tipos de Assinatura, os Combustíveis,
                as Configurações padrão de cadastro de cliente, os Produtos disponíveis, os Serviços,
                e muito mais.
              </p>
            </div>
          </div>
