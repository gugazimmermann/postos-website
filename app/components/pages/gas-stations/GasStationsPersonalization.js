...
const GasStationsPersonalization = () => {
  return (
    <section className='container mx-auto'>
      <div className='mx-4 sm:mx-0 mt-8 sm:mt-8 bg-amber-500 rounded-3xl shadow-xl'>
...
export default GasStationsPersonalization;
