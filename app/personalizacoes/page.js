  ...
  return (
    <Section>
      ...
      <SectionParagraph>
        ...
        mensagem reflita a identidade da sua marca. Se busca um tom mais formal ou informal, deseja
        destacar sua marca, informar promoções especiais ou enfatizar a bandeira do posto, estamos
        aqui para assegurar que suas mensagens sejam exatamente como você imagina.
      </SectionParagraph>
      ...
      <SectionParagraph>
        ...
        capacidade de personalizar o sistema de caixa, você pode alterar o visual do software usado
        pelos funcionários. Desde paletas de cores até layouts, a customização da interface do caixa
        possibilita um trabalho mais intuitivo para seus colaboradores, agilizando o atendimento e
        aumentando a satisfação do cliente.
      </SectionParagraph>
      <SectionSubTitle>Análise e Cobranças Transparentes</SectionSubTitle>
      <SectionParagraph>
        Reconhecemos que personalizações específicas podem influenciar nossos recursos e esforços de
        desenvolvimento. Nossa equipe dedicada avaliará atentamente suas solicitações para assegurar
        uma implementação eficaz e eficiente. É relevante mencionar que algumas customizações podem
        incorrer em custos adicionais. Porém, sempre priorizamos a transparência e garantimos que
        você estará informado sobre quaisquer despesas antes de continuarmos com o projeto.
      </SectionParagraph>
      <SectionSubTitle>Como Começar</SectionSubTitle>
      <SectionParagraph>
        Iniciar o processo de personalização é simples. Entre em contato conosco e compartilhe suas
        ideias e necessidades. Nosso time estará à disposição para orientá-lo sobre as opções
      ...
      <SectionParagraph>
        ...
        sistema de gerenciamento de frotas adaptado ao seu negócio. Nossas opções de personalização
        garantem que você maximize o potencial do nosso{' '}
