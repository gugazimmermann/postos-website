  ...
  const SingleButton = ({ closeButton = 'Fechar' }) => {
    return (
      <div className='bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse'>
        <button
          type='button'
          className='w-full inline-flex justify-center rounded-md border border-transparent  shadow-xl px-4 py-2 text-base font-medium text-white bg-red-600 hover:bg-red-700 sm:ml-3 sm:w-auto sm:text-sm'
          onClick={() => closeModal()}
        >
          {closeButton}
        </button>
