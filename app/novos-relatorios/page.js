    ...
    <Section>
      ...
      <div className='w-full mt-4'>
        ...
        <SectionParagraph>
          ...
          decisões bem informadas para o sucesso empresarial. Por esse motivo, oferecemos a
          capacidade de obter insights detalhados por meio de Relatórios e Gráficos Personalizados.
          Reconhecemos que cada posto de combustível possui métricas e áreas de interesse
          exclusivas, permitindo que você solicite relatórios específicos que atendam às suas
          necessidades.
        </SectionParagraph>
        <SectionParagraph>
          A compreensão dos dados é crucial para desenvolver uma estratégia eficaz. Nossos
          Relatórios e Gráficos Personalizados fornecem o contexto necessário para decisões
          confiantes e informadas. Imagine observar o crescimento das vendas dia a dia, analisar os
          efeitos das ações de marketing ou identificar áreas de aprimoramento operacional. A
          análise de dados se torna a base para alcançar objetivos ambiciosos.
        </SectionParagraph>
        ...
        <SectionParagraph>
          ...
          aprofundadas para decisões ou dados específicos para parceiros, desenvolvemos esses
          recursos para atender às suas necessidades exclusivas. Cada relatório é criado
          considerando sua perspectiva, trazendo clareza às informações cruciais para o sucesso.
        </SectionParagraph>
        ...
        <SectionParagraph>
          ...
          e compartilhar suas necessidades específicas. Quer esteja procurando detalhes sobre o
          consumo de combustível por tipo de veículo, análises sazonais de vendas ou qualquer outro
          indicador crucial, nossa equipe está pronta para trabalhar com você e criar relatórios que
          ofereçam insights sob medida.
        </SectionParagraph>
        ...
        <SectionParagraph>
          ...
          coração de um negócio inteligente. Nossos Relatórios e Gráficos Personalizados capacitam
          você a extrair informações valiosas dos seus dados e a tomar decisões informadas que
          impulsionam o crescimento do seu posto de combustível.
        </SectionParagraph>
      </div>
    </Section>
  );
